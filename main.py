...
class CustomerShoppingAnalyzer:
    ...
    def __init__(self, data_path):
        ...
        self.df = None
        self.results_dir = os.path.join(data_path, 'results')
    ...
    def customer_demographics_analysis(self):
        ...
        # Save the plot
        plt.savefig(os.path.join(self.results_dir, 'customer_demographics.png'), 
    ...
    def product_performance_analysis(self):
        ...
        # Save the plot
        plt.savefig(os.path.join(self.results_dir, 'product_performance.png'), 
                   dpi=300, bbox_inches='tight')
        plt.close()
    ...
    - Top market: {location_counts.index[0]} ({location_counts.iloc[0]} customers)"""
        ...
        # Save the plot
        plt.savefig(os.path.join(self.results_dir, 'us_customer_map.png'), 
                   dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def customer_segmentation_analysis(self):
        ...
        # Save the plot
        plt.savefig(os.path.join(self.results_dir, 'customer_segmentation.png'), 
                   dpi=300, bbox_inches='tight')
        plt.close()
    ...
    def purchase_behavior_pca_analysis(self):
        ...
        # Save the plot
        plt.savefig(os.path.join(self.results_dir, 'pca_behavior_analysis.png'), 
                   dpi=300, bbox_inches='tight')
        plt.close() 
